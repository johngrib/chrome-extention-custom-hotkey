...
- **Hotkey Dashboard**: 화면 우측 하단의 상태 배지(`발견된 개수/총 개수`)를 통해 활성화된 단축키 상태를 실시간으로 확인하고, 대시보드 패널(`Alt + Shift + /`)에서 전체 목록과 상태를 모니터링할 수 있습니다.
...
- **Hotkey Dashboard 토글**: `Alt + Shift + /` (또는 우측 하단 상태 배지 클릭)
